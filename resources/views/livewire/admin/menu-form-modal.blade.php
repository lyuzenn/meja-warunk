    ...
    <div class="flex items-end justify-center min-h-screen px-4 text-center md:items-center sm:block sm:p-0">
        ...
        <div class="inline-block w-full max-w-lg p-8 my-20 overflow-hidden text-left transition-all transform bg-white rounded-lg shadow-xl 2xl:max-w-2xl">
            <div class="flex items-center justify-between space-x-4">
                <h1 class="text-xl font-medium text-gray-800 ">{{ $menuId ? 'Edit Menu' : 'Tambah Menu Baru' }}</h1>
            ...
            <form class="mt-5">
                ...
                <div class="mt-4">
                    ...
                    @if ($newImage)
                        ...
                        <img src="{{ $newImage->temporaryUrl() }}" class="mt-1 h-20 w-20 object-cover rounded">
                    @elseif ($existingImage)
                        <p class="mt-2 text-xs text-gray-600">Gambar Saat Ini:</p>
                        <img src="{{ asset('storage/' . $existingImage) }}" class="mt-1 h-20 w-20 object-cover rounded">
                    @endif
