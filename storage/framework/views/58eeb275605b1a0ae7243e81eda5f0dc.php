    ...
    <div class="container mx-auto max-w-md p-4">
        <div class="bg-white rounded-lg shadow-lg p-8 text-center">
            ...
            <?php elseif($order->status == 'completed'): ?>
                ...
                <a href="<?php echo e(route('order.rate', $order->id)); ?>"
            ...
            <div class="mt-6 border-t pt-4 text-sm text-gray-500">
                <p>ID Pesanan: <span class="font-semibold"><?php echo e($order->midtrans_order_id); ?></span></p>
            </div>
        </div>
    </div>
</body>
</html>
<?php /**PATH C:\Users\Lyuzenn\laravel\meja-warunk\resources\views/order-finish.blade.php ENDPATH**/ ?>