                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $topSellingMenus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap"><div class="text-sm font-medium text-gray-900"><?php echo e($item->menu->name ?? 'Menu Dihapus'); ?></div><div class="text-sm text-gray-500"><?php echo e($item->menu->category ?? ''); ?></div></td>
        ...
        document.addEventListener('alpine:init', () => {
            Alpine.data('salesChart', () => ({
                ...
                init() {
                    ...
                    let initialData = <?php echo e(Illuminate\Support\Js::from($this->salesDataForChart)); ?>;
...
<?php /**PATH C:\Users\Lyuzenn\laravel\meja-warunk\resources\views/livewire/admin/sales-report.blade.php ENDPATH**/ ?>