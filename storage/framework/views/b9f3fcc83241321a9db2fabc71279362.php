<div class="bg-gray-200">
    ...
    <div class="relative mx-auto max-w-sm min-h-screen bg-gray-100 shadow-2xl pb-28">
        ...
        <header class="bg-amber-900 text-white shadow-lg sticky top-0 z-40 p-3 flex items-center">
            <a href="<?php echo e(route('menu.show', ['table' => $tableId])); ?>" class="text-white">
        ...
        <main class="p-4">
            ...
            <div class="bg-white rounded-lg shadow p-4 space-y-6">
                ...
                <div>
                    ...
                    <div class="space-y-4">
                        <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $cart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="flex items-center" wire:key="cart-item-<?php echo e($id); ?>">
                                ...
                                <div class="flex items-center justify-between bg-gray-200 rounded-lg p-1 w-28">
                                    <button wire:click="decrementQuantity(<?php echo e($id); ?>)" class="text-lg font-bold text-red-600 px-2 rounded-md">-</button>
                                    <span class="font-bold px-2 text-gray-800"><?php echo e($item['quantity']); ?></span>
                                    <button wire:click="incrementQuantity(<?php echo e($id); ?>)" class="text-lg font-bold text-green-600 px-2 rounded-md">+</button>
                                </div>
                            </div>
                    ...
                    <a href="<?php echo e(route('menu.show', ['table' => $tableId])); ?>" class="mt-4 inline-flex items-center text-amber-800 font-semibold hover:underline">
                ...
                <!-- PERUBAHAN: Bagian Rincian Pembayaran dipindah ke sini -->
                <div class="pt-4 border-t">
                    ...
                    <div class="text-sm space-y-1">
                        ...
                        <div class="flex justify-between">
                            <span class="text-gray-600">PPN (<?php echo e($taxRate * 100); ?>%)</span>
    ...
    <!-- PERUBAHAN: Bar Tombol Pesan (Floating) hanya berisi tombol -->
...
<?php /**PATH D:\Kuliah\Semester 4\PWEB\meja-warunk\resources\views/livewire/checkout-page.blade.php ENDPATH**/ ?>