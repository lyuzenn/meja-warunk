...
<body>
    <div class="container">
        ...
        <div class="order-details">
            <p><strong>Order ID:</strong> <?php echo e($order->midtrans_order_id); ?></p>
            <p><strong>Customer:</strong> <?php echo e($order->customer_name); ?></p>
            <p><strong>Meja:</strong> <?php echo e($order->table_id); ?></p>
            <p><strong>Subtotal:</strong> Rp <?php echo e(number_format($order->subtotal ?? 0, 0, ',', '.')); ?></p>
            <p><strong>Pajak:</strong> Rp <?php echo e(number_format($order->tax_amount ?? 0, 0, ',', '.')); ?></p>
            <p><strong>Total:</strong> <span style="font-size: 18px; color: #28a745;">Rp <?php echo e(number_format($order->total_price, 0, ',', '.')); ?></span></p>
        </div>
    ...
    <script>
        document.getElementById('pay-button').onclick = function() {
            ...
            console.log('Creating payment for order ID:', <?php echo e($order->id); ?>);
                    ...
                    snap.pay(data.snap_token, {
                        onSuccess: function(result) {
                            ...
                            .then(updateData => {
                                ...
                                window.location.href = '/order/<?php echo e($order->id); ?>/status';
                            })
                            .catch(error => {
...
<?php /**PATH D:\Kuliah\Semester 4\PWEB\meja-warunk\resources\views/payment.blade.php ENDPATH**/ ?>